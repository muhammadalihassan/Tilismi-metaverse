...
<div class="container-fluid top-head">
  ...
  <a class="navbar-brand" href="index.php"><img src="images/logo.png" alt="Logo" class="logo-n">
<img src="images/logo-b.png" alt="Logo" class="logo-b">
<img src="images/logo-y.png" alt="Logo" class="logo-y">
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link req-demo-btn stan-btn" href="#">request demo</a>
      </li>
    </ul>
  </div>
</nav>
