        ...
        <div class="row">
            <div class="col-12 align-self-center">
                <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                    <div class="w-sm-100 mr-auto"><h4 class="mb-0">All Leave Application</h4></div>
                        ...
                        <div class="invoices list">
                            ...
                            <div class="invoice {{$stat}}" data-status="{{$stat}}">
                                <div class="invoice-content" data-status="{{$stat}}">
                                    ...
                                    <div class="">
                                        <p class="mb-0 small">App Details:</p>
                                       
                                        <button type="button" style="font-size: 10px;" data-html="true" class="btn btn-lg btn-danger" data-toggle="popover" title="" data-content="<b>Start Date: </b> of leave is {{date('d M Y' , strtotime($leave->start_date))}} <br> <b>End Date: </b> is {{date('d M Y' , strtotime($leave->end_date))}} <br> <b>Reason</b>: '{{$leave->reason}}' {{isset($leave->update_reason)?'<br> <b>Comments: </b>  '.$leave->update_reason:''}} {{isset($leave->update_reason)?'<br> <b>Updated By: </b>  '.$leave->linemanager->name:''}}" data-original-title="{{$leave->title}}">
                                            View
                                        </button>
                                    </div>

                                    <div class="">
                                        <p class="mb-0 small">Emp Detail:</p>
                                        <button type="button" style="font-size: 10px;" data-html="true" class="btn btn-lg btn-danger" data-toggle="popover" title="" data-content="<b>Departments</b> : {{$leave->employee->departments->name}} <br> <b>Designations</b> : {{$leave->employee->designations->name}}" data-original-title="{{$leave->employee->name}}">
                                            View
                                        </button>
                                    </div>
