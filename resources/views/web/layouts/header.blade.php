...
<div class="container-fluid top-head">
  ...
  <a class="navbar-brand" href="index.php"><img src="{{asset('web/images/logo.png')}}" alt="Logo" class="logo-n">
<img src="{{asset('web/images/logo-b.png')}}" alt="Logo" class="logo-b">
<img src="{{asset('web/images/logo-y.png')}}" alt="Logo" class="logo-y">
  </a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <img src="{{asset('web/images/logo.png')}}" alt="Logo" class="logo-n">
        <span>
    ...
    <div class="modal-content">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <div class="row bg-grey">
            ...
            <div class="col-md-6">
               <div class="form-img">
                  <img src="{{asset('web/images/popimg.jpeg')}}" alt="form">
               </div>
            </div>
         </div>
    </div>
