                                ...
                                <div class="card-body p-4">                                   
                                    <div class="d-flex">                                        
                                        ...
                                        <div class="media-body align-self-center pl-3">
                                            ...
                                            <p class="mb-0 font-w-500 h6">{{$signal_report_count}}</p>                                                    
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-4">                                   
                                    <div class="d-flex">                                        
                                        ...
                                        <div class="media-body align-self-center pl-3">
                                            ...
                                            <p class="mb-0 font-w-500 h6">{{$education_count}}</p>                                                    
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card outline-badge-primary">                            
                            <div class="card-content">
                                <div class="card-body p-4">   
                                    <div class="d-md-flex">
                                        <div class="my-auto">
                                            <img src="{{asset('images/money-w.png')}}" alt="author"  class="my-auto">
                                        </div>
                                    ...
                                    <ul class="list-group list-unstyled">
                                        ...
                                        <li class="p-2 border-bottom">
                                            <div class="media d-flex w-100">
                                                <div class="circle-40 outline-badge-{{$colors[rand(0,5)]}}"><span>{{mb_substr($order->user->name, 0, 1, 'utf-8')}}</span></div>
                                                <div class="media-body align-self-center pl-2">
                                                    <span class="mb-0 font-w-600">{{$order->user->name}}</span><br>
                                                    <small class="mb-0 font-w-500">{{$order->user->email}}</small>
                                                </div>
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-unstyled">
                                        <li class="p-4 border-bottom">
                                            <div class="media d-flex w-100">
                                                <div class="circle-40 outline-badge-primary"><span>{{mb_substr($order->user->name, 0, 1, 'utf-8')}}</span></div>
                                                <div class="media-body align-self-center pl-2">
                                                    <span class="mb-0 font-w-600">{{$order->user->username}}</span><br>
                                                    <small class="mb-0 font-w-500">{{$order->user->email}}</small>                                                    
                                                </div>
                                                <div class="ml-auto my-auto font-weight-bold">
                                                    ${{number_format($order->amount ,2)}}
                                            ...
                                            <div class="media d-flex w-100">
                                                ...
                                                <div class="ml-auto my-auto font-weight-bold">
                                                    <a href="" class="btn btn-outline-primary font-w-600 my-auto text-nowrap">Connect {{$order->user->name}}</a> 
                                                </div>
                                            </div>
                                        </li> 
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless pick-table mb-2">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>USD</td>                                                   
                                                    <td class="text-right text-success">${{number_format($order->amount ,2)}} <i class="ion ion-arrow-graph-up-right"></i></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                            <div class="py-3 border-bottom border-primary">
                                                ...
                                                <p class="mb-0 font-w-500 h3">{{$book_count}}</p>
                                            </div>
                                            <div class="table-responsive">
                                                <table class="table table-borderless pick-table mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right text-success">{{$data->created_at->diffForHumans()}} <i class="ion ion-arrow-graph-up-right"></i></td>
                                                        </tr>
                                                        @endif
                                                        @endif
                                                        @endforeach
                                        ...
                                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                            <div class="py-3 border-bottom border-primary">
                                                ...
                                                <p class="mb-0 font-w-500 h3">{{$video_count}}</p>                                                    
                                            </div>
                                            <div class="table-responsive">
                                                <table class="table table-borderless pick-table mb-0">
                                                    <table class="table table-borderless pick-table mb-0">
                                        ...
                                        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                            <div class="py-3 border-bottom border-primary">
                                                ...
                                                <p class="mb-0 font-w-500 h3">{{$signal_report_count}}</p>                                                    
                                            </div>
                                            <div class="table-responsive">
                                                <table class="table table-borderless pick-table mb-0">
                                                    <thead>
