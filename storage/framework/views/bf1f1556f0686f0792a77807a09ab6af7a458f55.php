		...
		<div class="row">
			<div class="col-md-9">
				<div class="all-blogs-main">
					<div class="row">
					<?php $__currentLoopData = $all_blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latestBlog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class="col-md-6">
							...
							<div class="blog-wid">
								...
								<h4><?php echo e(isset($latestBlog->heading)?Str::limit($latestBlog->heading,40):''); ?></h4>
...
<?php echo $__env->make('web.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\fareeha shah\Tilismi_new_update\resources\views/web/blogs.blade.php ENDPATH**/ ?>