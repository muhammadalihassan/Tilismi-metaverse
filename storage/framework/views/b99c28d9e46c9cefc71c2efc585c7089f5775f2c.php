                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <div class="application-orga">
                            ...
                            <div class="swipea-floating-control">
                 <input type="text" name="address" id="address" placeholder="Enter your address" required class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <div class="application-orga">
                            ...
                            <div class="swipea-floating-control">
                 <input type="number" name="phonenumber" id="phonenumber" placeholder="Enter your Phone Number" required class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        <div class="application-orga">
                            ...
                            <div class="swipea-floating-control">
                 <input type="password" name="confirm_password" id="confirm_password" placeholder="Enter your Confirm Password" required class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="apply-form3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button type="submit" id="application-form-submit" class="btn btn-primary ">
                                        Submit
                                    </button>
                                </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="Password" required="" name="password">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FareehaShah\Grappling_Zone\grappling_zone\resources\views/web/user-registration.blade.php ENDPATH**/ ?>