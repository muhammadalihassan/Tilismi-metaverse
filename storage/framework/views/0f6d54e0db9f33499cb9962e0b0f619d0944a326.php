...
<html lang="en">
   <head>
      <meta charset="UTF-8">
      <title>My Mobile Dna. | Registration Inquiry</title>
   </head>
   <body>
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td align="left" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575;padding: 0px 51px;line-height: 0.8rem; font-weight: 300;">
                              ...
                              <p>User Name : <b><?=$details['username']?></b></p>
...
</html><?php /**PATH /home2/digitalservicesc/public_html/mymobiledna-dev/resources/views/emails/user-registration.blade.php ENDPATH**/ ?>