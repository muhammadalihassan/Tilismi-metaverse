                ...
                <tr class="space">
                  ...
                  <td class="col-md-3">
                    <div class="number-item">
                              <input type="number" class="qtystyle" name="quanity" value="<?php echo e($details['quantity']); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FareehaShah\Grappling_Zone\grappling_zone\resources\views/web/cart.blade.php ENDPATH**/ ?>