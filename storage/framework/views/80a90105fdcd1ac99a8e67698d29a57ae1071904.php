  ...
  <div class="banner-form">
    <form method="POST" action="<?php echo e(route('login')); ?>">
      ...
      <h3>Login</h3>
      <input type="email" id="email" name="email" placeholder="Email Address" class="email-letter">
...
unset($__errorArgs, $__bag); ?>
      ...
      <button class="hover-btn">Submit</button><p class="center">Create Account , <a href="<?php echo e(route('user_register')); ?>">Sign Up</a></p>
    ...
    <li class='<?=(isset($navitem) && $navitem=="faq")?"active":"" ?>'><a href="<?php echo e(route('faq')); ?>"><?php echo e($nav5->name); ?></a></li>
      ...
      <li class='<?=(isset($navitem) && $navitem=="faq")?"active":"" ?>'><a href="<?php echo e(route('stripe_payment')); ?>">stripe</a></li>
    </ul>
    </nav>
        </div>
    ...
    <!-- Header End --><?php /**PATH D:\FareehaShah\dna_update_4\resources\views/web/layouts/header.blade.php ENDPATH**/ ?>