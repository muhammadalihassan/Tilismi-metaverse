...
<html lang="en">
   <head>
      <meta charset="UTF-8">
      <title>Mapline Energy | Newsletter Subscription</title>
   </head>
   <body>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td align="center" style="line-height: 0px;">
                                       <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="<?php echo e(asset('images/logo.png')); ?>"  alt="Mapline Energy">
                                    </td>
                                 </tr>
                                 <tr>
               ...
               <td align="center">
                  <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px; margin-right:20px; border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9;">
                     <tbody>
                        ...
                        <tr>
                           <td align="center" style="font-family: 'Raleway', sans-serif; font-size:22px; font-weight: bold; color:#333;">Newsletter Subscription</td>
                        </tr>
                        <tr>
                           <td height="10"></td>
                        </tr>
                        <tr>
                           <td align="left" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575;padding: 0px 51px;line-height: 0.8rem; font-weight: 300;">
                              ...
                              You're now signed up for the best newsletter for those who make and drink great beer. If you did not intend to subscribe, please ignore our confirmation email.
                           </td>
                        </tr>
                     </tbody>
                  </table>
...
</html><?php /**PATH D:\FareehaShah\Grappling_Zone\grappling_zone\resources\views/emails/newsletter-email.blade.php ENDPATH**/ ?>