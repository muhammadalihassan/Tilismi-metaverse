		...
		<div class="row">
			<div class="col-md-9">
				<div class="inner-news">
					...
					<p><?php echo e(isset($blogs->paragraph)?html_entity_decode($blogs->paragraph):''); ?></p>
						...
						<div class="row">
							<div class="col-md-5">
								...
								<div class="col-md-7 no-left">
									<div class="news-txt">
										<h5><?php echo e(isset($latestBlog->paragraph)?html_entity_decode($latestBlog->paragraph):''); ?></h5>
										<span class="creation-date">
											<i class="fa fa-calendar" aria-hidden="true"></i>
...
<?php echo $__env->make('web.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\fareeha shah\Tilismi\resources\views/web/blogs-detail.blade.php ENDPATH**/ ?>