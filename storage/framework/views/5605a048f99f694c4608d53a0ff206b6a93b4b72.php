...
<html lang="en">
   <head>
      <meta charset="UTF-8">
      <title>MyMobileDna. | Contact Form</title>
   </head>
   <body>
               ...
               <td align="center">
                  <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px; margin-right:20px; border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9;">
                     <tbody>
                        ...
                        <tr>
                           <td align="center" style="font-family: 'Raleway', sans-serif; font-size:22px; font-weight: bold; color:#333;">CONTACT FORM</td>
                        </tr>
                        <tr>
                           <td height="10"></td>
                        </tr>
                        <tr>
                           <td align="left" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575;padding: 0px 51px;line-height: 0.8rem; font-weight: 300;">
                              ...
                              <p>Im : <b><?=$details['select_im']?></b></p>
                              <p>Email : <b><?=$details['email']?></b></p>
                              <p>Phone number  : <b><?=$details['phoneNumb']?></b></p>
...
</html><?php /**PATH D:\FareehaShah\dna_update_code\resources\views/emails/contact-us.blade.php ENDPATH**/ ?>