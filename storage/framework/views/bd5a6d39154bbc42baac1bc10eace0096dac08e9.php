...
<div class="news-banner-main">
	<img src="<?php echo e(asset('web/images/newsbg.jpg')); ?>">
	<h4>news</h4>
</div>
<div class="news-main">
	<div class="container-fluid">
						...
						<div class="col-md-5">
							<div class="all-news-main">
								<div class="all-news">
										...
										<div class="row">
											...
											<div class="col-md-7 no-left">
												<div class="news-txt">
													...
													<h5><?php echo e(isset($allNews->heading)?Str::limit($allNews->heading,90):''); ?></h5>
													<span class="creation-date">
														<i class="fa fa-calendar" aria-hidden="true"></i>
														<span><?php echo e(date('M d,Y' , strtotime($allNews->created_at))); ?></span>
													</span>
									...
									<?php endif; ?>
									<?php if($key != 0 && (($key % 3 == 0 && $key <= 3) || $key % (sizeof($all_news) - 1)==0)): ?>
								 </div>
								</div>
							...
							<?php elseif(sizeof($all_news) == 1): ?>
							</div>
							</div>
							<?php if($all_news->currentPage() > 1 && $all_news->count() < 5): ?>
							<div class="flex flex-col justify-between space-y-4 px-4 py-4 sm:flex-row sm:items-center sm:space-y-0 sm:px-5">
								<ol class="pagination">
									<?php echo $all_news->render(); ?>

								</ol>
							</div><!-- Pagination on page other than page 1 and record count less 5 -->
							<?php endif; ?>
							</div>
							<?php endif; ?>
								...
								<div class="all-news">
									...
									<a href="<?php echo e(route('news_detail',['id'=>urlencode(base64_encode($allLatesNews->id))])); ?>">
										<div class="row">
											...
											<div class="col-md-7 no-left">
												<div class="news-txt">
													<h5><?php echo e(isset($allLatesNews->heading)?Str::limit($allLatesNews->heading,60):''); ?></h5>
													<span class="creation-date">
														<i class="fa fa-calendar" aria-hidden="true"></i>
		...
		<?php echo $__env->make('web.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tilismi_new_update\resources\views/web/news.blade.php ENDPATH**/ ?>