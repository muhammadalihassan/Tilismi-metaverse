            ...
            <div class="appointment-work">
               <form id="address-form" action="<?php echo e(route('appointment_submit')); ?>" method="POST" autocomplete="off">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <input type="date" id="expiry" name="exp_date" required placeholder="Expiration Date" style="text-transform: capitalize;">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6">
                  ...
                  <div class="row prt1">
                     ...
                     <div class="col-md-6">
                        <div id="signature">
                       <span>Signature</span>
                       <canvas width="300" height="148" id="signaturePad" name="signaturePad"></canvas>
                       <div class="controls">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Malaika\dna_update_4\dna_update_4\resources\views/web/appointment.blade.php ENDPATH**/ ?>