                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" readonly="" disabled="" name="username" id="validationCustomUsername" placeholder="Username" aria-describedby="inputGroupPrepend" value="<?php echo e($user->username); ?>" required>
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        <label for="validationCustomUsername">Emergency Number</label>
                                                        <div class="input-group">
                                                            
                                                            <input type="tel" class="form-control" name="emergency_number" data-inputmask="'mask': '0399-99999999'" id="validationCustomUsername" placeholder="Emergency Number" aria-describedby="inputGroupPrepend" value="<?php echo e($user->emergency_number); ?>" required>
                                                            <div class="invalid-feedback">
                                                                Please enter your Emergency number.
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/digitalservicesc/public_html/mymobiledna-dev/resources/views/user-profile.blade.php ENDPATH**/ ?>