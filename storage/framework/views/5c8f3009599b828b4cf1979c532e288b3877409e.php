...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" style="text-transform: none;" >
...
unset($__errorArgs, $__bag); ?>
   ...
   <?php endif; ?>
    ...
    <!-- Header End -->
<?php /**PATH /home2/digitalservicesc/public_html/mymobiledna-dev/resources/views/web/layouts/header.blade.php ENDPATH**/ ?>