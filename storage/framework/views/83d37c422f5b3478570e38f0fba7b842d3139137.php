        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="bnr-heading" data-aos="fade-up" data-aos-duration="3000">
              ...
              <p data-aos="fade-right">Grappling Zone Association is registered with the (IBJJF) International Brazilian Jiu-Jitsu Federation, the (NAJJU) North American Jiu-Jitsu Union, (PJJF) PanAmerican.</p>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="bnr-heading" data-aos="fade-up">
              ...
              <p>Grappling Zone Association is registered with the (IBJJF) International Brazilian Jiu-Jitsu Federation, the (NAJJU) North American Jiu-Jitsu Union, (PJJF) PanAmerican.</p>
            ...
            <div class="our-pro-blk">
              ...
              <div class="mer-images">
                ...
                <input type="hidden" name="product_id" value="<?php echo e($product->id); ?>">
                 <button type="submit" class="text"><i class="fa fa-shopping-bag" aria-hidden="true"></i>Add to Cart</button>
                </div>
              </form>
      ...
      <div class="vid-area">
        ...
        <div class="play-btn">
         ...
         <div class="play">
          ...
          <a data-fancybox="gallery" data-src="<?php echo e(asset('images/video.mp4')); ?>" width="100%" height="500" controls="controls" preload="metadata">
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FareehaShah\Grappling_Zone\grappling_zone\resources\views/web/index.blade.php ENDPATH**/ ?>