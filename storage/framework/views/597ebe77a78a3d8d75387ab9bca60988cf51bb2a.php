         ...
         <div class="col-md-12">
            <div class="appointment-work">
               <form id="address-form" action="<?php echo e(route('appointment_submit')); ?>" method="POST" autocomplete="off">
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <input id="totalfee" name="total" required placeholder="Total $" style="text-transform: capitalize;" value="" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FareehaShah\dna_update_5\dna_update_4\resources\views/web/appointment.blade.php ENDPATH**/ ?>