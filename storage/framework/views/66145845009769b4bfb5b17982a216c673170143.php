...
<link rel="stylesheet" href="<?php echo e(asset('css/formcss.css')); ?>">
    ...
    <form action="<?php echo e(route('update_by_dna')); ?>" method="POST">
      <?php echo csrf_field(); ?>

     <input type="hidden" name="id" value="<?php echo e($legalinquiry->id); ?>">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                              <div class="lab-use">
                                <h4>Customer ID</h4>
                     <input type="text" name="customer_Id" id="customer_Id" value="<?php echo e($legalinquiry->customer_Id == '' ? '-' : $legalinquiry->customer_Id); ?>"> 
                            </div>
                        ...
                        <div class="labortory-inr">
                            ...
                            <div class="pckge-rcve">
                                <div class="option">
                                    ...
                                    <div class="multiple-opt"><input type="checkbox" /><label>Yes</label> <input type="checkbox" /><label>No</label></div>
                                </div>
                                ...
                                <div class="recive-by">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label>Received By<span>(Printed Name):</span></label><input type="text" name="recvd_by_patient_name"value="<?php echo e($legalinquiry->recvd_by_patient_name == '' ? '-' : $legalinquiry->recvd_by_patient_name); ?>"  />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="collect-date">
                                        <div class="signaturee"><label>Reciptent Signature:</label><input type="text" name="recvd_signature"  value="<?php echo e($legalinquiry->recvd_signature == '' ? '-' : $legalinquiry->recvd_signature); ?>" /></div>
                                        <div class="date">
                                            <label>Date:<input type="text" name="dna_date" value="<?php echo e($legalinquiry->dna_date == '' ? '-' : $legalinquiry->dna_date); ?>"/></label>
                                        </div>
                                        <div class="timee">
                                            <label>Time:<input type="text" name="dna_time"value="<?php echo e($legalinquiry->dna_time == '' ? '-' : $legalinquiry->dna_time); ?>" /></label>
                                        </div>
                                        <div class="time-inr">
                                     <label><input type="checkbox" name="time_select" value="<?php echo e($legalinquiry->time_select == 'AM' ? 'checked' : ''); ?> " />AM</label>
                                <label><input type="checkbox" name="time_select" value="<?php echo e($legalinquiry->time_select == 'PM' ? 'checked' : ''); ?> "/>PM</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="labortory-notes">
                                    <div class="notes">
                                        ...
                                        <input type="text" name="dna_note" value="<?php echo e($legalinquiry->dna_note == '' ? '-' : $legalinquiry->dna_note); ?>" />
                                    </div>
                                    <div class="note-input">
                                        <input type="text" name="dna_note" value="<?php echo e($legalinquiry->dna_note == '' ? '-' : $legalinquiry->dna_note); ?>" />
                                        <input type="text" value="<?php echo e($legalinquiry->dna_note == '' ? '-' : $legalinquiry->dna_note); ?>"  />
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?><?php /**PATH D:\FareehaShah\dna_update_5\dna_update_4\resources\views/web/dna-view-report.blade.php ENDPATH**/ ?>