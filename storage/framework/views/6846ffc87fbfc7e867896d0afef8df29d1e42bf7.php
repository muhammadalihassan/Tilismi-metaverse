...
<div class="sidebar">
          ...
          <!-- <li class="active"><a href="<?php echo e(route('dashboard')); ?>"><i class="icon-rocket"></i> Dashboard</a></li> -->
           ...
           <li class="active"><a href="<?php echo e(route('welcome')); ?>"><i class="icon-rocket"></i> View Website</a></li>
                ...
                <a href="<?php echo e(route('cutomer_view_nonlegal_reports')); ?>"><i class="icon-energy"></i>Send By Dna Non Legal Report</a>
                   ...
                   <?php if(Auth::user()->role_id == 4): ?> 
                    ...
                    <li class="dropdown"><a href="#"><i class="icon-organization mr-1"></i> Tools</a>
                        <ul>
                 <li class="dropdown"><a href="#"><i class="fa fa-file"></i>Reports</a>
                 <ul class="sub-menu">
                     <?php if(Auth::user()->role_id == 1): ?>
        ...
        </div><?php /**PATH /home2/digitalservicesc/public_html/mymobiledna-dev/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>