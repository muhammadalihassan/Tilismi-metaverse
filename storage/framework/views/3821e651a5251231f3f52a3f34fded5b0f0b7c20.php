               ...
               <form id="address-form" action="<?php echo e(route('user_registration')); ?>" method="POST" autocomplete="off">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        ...
                        <input type="email" id="email2" name="email" placeholder="Email" class="email-letter" required />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/digitalservicesc/public_html/mymobiledna-dev/resources/views/web/user-register.blade.php ENDPATH**/ ?>