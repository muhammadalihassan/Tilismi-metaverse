...
<html lang="en">
   <head>
      <meta charset="UTF-8">
      <title>MyMobileDna. | Feedback Form</title>
   </head>
   <body>
               ...
               <td align="center">
                  <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px; margin-right:20px; border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9;">
                     <tbody>
                        ...
                        <tr>
                           <td align="center" style="font-family: 'Raleway', sans-serif; font-size:22px; font-weight: bold; color:#333;">Feedback FORM</td>
                        </tr>
                        <tr>
                           <td height="10"></td>
                        </tr>
...
</html><?php /**PATH D:\FareehaShah\dna_update_code\resources\views/emails/feedback.blade.php ENDPATH**/ ?>