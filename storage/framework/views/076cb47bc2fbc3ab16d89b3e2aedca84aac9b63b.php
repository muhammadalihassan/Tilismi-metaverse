...
<html lang="en">
   <head>
      <meta charset="UTF-8">
      <title>TILISMI. | Contact Inquiry</title>
   </head>
   <body>
            ...
            <tr>
               <td align="center">
                  <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                     <tbody>
                        <tr>
                           <td align="center" valign="top" background="<?php echo e(asset('web/images/logo.png')); ?>" bgcolor="#66809b" style="background-size:cover; background-position:top; background-size: cover;
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td align="center" style="line-height: 0px;">
                                       <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="<?php echo e(asset('web/images/logo.png')); ?>"  alt="DS Medical Supplies Inc">
                                    </td>
                                 </tr>
                                 <tr>
               ...
               <td align="center">
                  <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px; margin-right:20px; border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9;">
                     <tbody>
                        ...
                        <tr>
                           <td align="center" style="font-family: 'Raleway', sans-serif; font-size:22px; font-weight: bold; color:#333;">CONTACT INQUIRY</td>
                        </tr>
                        <tr>
                           <td height="10"></td>
                        </tr>
                        <tr>
                           <td align="left" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575;padding: 0px 51px;line-height: 0.8rem; font-weight: 300;">
                              <p>Full Name : <b><?=$details['fname']?></b></p>
                              <p>Email : <b><?=$details['email']?></b></p>
                              <p>Phone number  : <b><?=$details['phone_number']?></b></p>
                                             ...
                                             <tbody>
                                                <tr>
                                                   <td align="center" width="30%" style="vertical-align: top;">
                                                      <a href="https://twitter.com/i/flow/login" target="_blank"> <img src="https://webdevtrick.com/wp-content/uploads/icon-twitter.png"> </a>
                                                   </td>
                                                   <td align="center" class="margin" width="30%" style="vertical-align: top;">
                                                      <a href="" target="_blank"> <img src="https://webdevtrick.com/wp-content/uploads/icon-fb.png"> </a>
                                                   </td>
                                                   <td align="center" width="30%" style="vertical-align: top;">
                                                      <a href="" target="_blank"> <img src="https://webdevtrick.com/wp-content/uploads/icon-googleplus.png"> </a>
                                                   </td>
                                                </tr>
                                             </tbody>
                                          </table>
...
</html><?php /**PATH C:\fareeha shah\Tilismi_new_update\resources\views/emails/contact-us.blade.php ENDPATH**/ ?>