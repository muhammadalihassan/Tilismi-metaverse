                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>" class="row row-eq-height lockscreen  mt-5 mb-5">                        
                        ...
                        <div class="lock-image col-12 col-sm-5">
                            <div class="login-logo">
                                <img src="<?php echo e(asset('web/images/logo-ftr.png')); ?>">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tilismi_new_update\resources\views/auth/login.blade.php ENDPATH**/ ?>