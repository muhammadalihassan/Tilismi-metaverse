...
<html lang="en">
   <head>
      <meta charset="UTF-8">
      <title>GAPPLING ZONE. | Contact Inquiry</title>
   </head>
   <body>
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td align="left" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575;padding: 0px 51px;line-height: 0.8rem; font-weight: 300;">
                              <p>First Name : <b><?=$details['fname']?></b></p>
                              <p>Last Name : <b><?=$details['lname']?></b></p>
...
</html><?php /**PATH D:\FareehaShah\Grappling_Zone\grappling_zone\resources\views/emails/contact-us.blade.php ENDPATH**/ ?>